...
def get_list_game_names_and_scores_by_count_range(btm, cnt):
    ...
    return draw_util.draw_score_box(data, 'Distribution of Metascore', "Game Name")
...
def get_list_media_names_and_scores_by_count_range(btm, cnt):
    ...
    return draw_util.draw_score_box(data, 'Distribution of Metascore', "Media Name")


def get_list_ratings_and_scores():
    data = game_dao.get_list_ratings_and_scores()
    return draw_util.draw_score_box(data, 'Distribution of Metascore', "Rating")


def get_list_game_names_and_scores_by_average_score_range(btm, cnt):
    data = game_dao.get_list_game_names_and_scores_by_average_score_range(btm, cnt)
    return draw_util.draw_score_box(data, 'Distribution of Metascore', "Game Name")


def get_descriptors_and_scores():
    data = game_dao.get_descriptors_and_scores()
    return draw_util.draw_score_box(data, 'Distribution of Metascore', "Descriptor")
