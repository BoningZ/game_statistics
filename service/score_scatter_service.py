...
def get_metascores_and_userscores_by_publisher_names(names):
    ...
    draw_util.draw_score_scatter(data, 'Media vs. User by Publishers')
...
def get_metascores_and_userscores_by_platform_names(names):
    ...
    draw_util.draw_score_scatter(data, 'Media vs. User by Platforms')
...
def get_metascores_and_userscores_by_game_names(names):
    ...
    draw_util.draw_score_scatter(data, 'Media vs. User by Series')
