...
def get_list_dates_and_scores_by_publisher_names(names):
    ...
    return draw_util.draw_score_date_line(data, 'Metascore over Time by Publishers')
...
def get_list_dates_and_scores_by_platform_names(names):
    ...
    return draw_util.draw_score_date_line(data, 'Metascore over Time by Platforms')
...
def get_list_dates_and_scores_by_game_names(names):
    ...
    return draw_util.draw_score_date_line(data, 'Metascore over Time by Series')
